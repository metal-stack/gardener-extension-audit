...
func NewCustomForwarding(outputConfig *corev1.ConfigMap, secret *corev1.Secret) (CustomForwarding, error) {
	...
	return CustomForwarding{outputConfig: config, secret: secret}, nil
}
