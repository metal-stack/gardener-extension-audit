...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*AuditHost)(nil), (*audit.AuditHost)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AuditHost_To_audit_AuditHost(a.(*AuditHost), b.(*audit.AuditHost), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*audit.AuditHost)(nil), (*AuditHost)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_audit_AuditHost_To_v1alpha1_AuditHost(a.(*audit.AuditHost), b.(*AuditHost), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AuditConfig_To_audit_AuditConfig(in *AuditConfig, out *audit.AuditConfig, s conversion.Scope) error {
	...
	out.Hosts = *(*[]audit.AuditHost)(unsafe.Pointer(&in.Hosts))
	return nil
}
...
func autoConvert_audit_AuditConfig_To_v1alpha1_AuditConfig(in *audit.AuditConfig, out *AuditConfig, s conversion.Scope) error {
	...
	out.Hosts = *(*[]AuditHost)(unsafe.Pointer(&in.Hosts))
	return nil
}
...
func autoConvert_v1alpha1_AuditHost_To_audit_AuditHost(in *AuditHost, out *audit.AuditHost, s conversion.Scope) error {
	out.IP = in.IP
	out.HostNames = *(*[]string)(unsafe.Pointer(&in.HostNames))
	return nil
}

// Convert_v1alpha1_AuditHost_To_audit_AuditHost is an autogenerated conversion function.
func Convert_v1alpha1_AuditHost_To_audit_AuditHost(in *AuditHost, out *audit.AuditHost, s conversion.Scope) error {
	return autoConvert_v1alpha1_AuditHost_To_audit_AuditHost(in, out, s)
}

func autoConvert_audit_AuditHost_To_v1alpha1_AuditHost(in *audit.AuditHost, out *AuditHost, s conversion.Scope) error {
	out.IP = in.IP
	out.HostNames = *(*[]string)(unsafe.Pointer(&in.HostNames))
	return nil
}

// Convert_audit_AuditHost_To_v1alpha1_AuditHost is an autogenerated conversion function.
func Convert_audit_AuditHost_To_v1alpha1_AuditHost(in *audit.AuditHost, out *AuditHost, s conversion.Scope) error {
	return autoConvert_audit_AuditHost_To_v1alpha1_AuditHost(in, out, s)
}
