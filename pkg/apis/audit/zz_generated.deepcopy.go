...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuditHost) DeepCopyInto(out *AuditHost) {
	*out = *in
	if in.HostNames != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuditHost.
func (in *AuditHost) DeepCopy() *AuditHost {
	if in == nil {
		return nil
	}
	out := new(AuditHost)
